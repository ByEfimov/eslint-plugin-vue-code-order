...
exports.getCategoryForFunction = void 0;
...
const defaultGroups = {
    ...
    "framework-init": {
        ...
        description: "🔧 Framework initialization - Vue, Nuxt, and core composables",
    },
    stores: {
        patterns: [
            ".*[Ss]tore$",
    ...
    "computed-hooks": {
        ...
        description: "🔄 Computed & Custom Hooks - Computed properties and custom composables",
    },
    "app-functions": {
        patterns: [
            "^(handle|on)[A-Z].*",
    ...
    "watchers-listeners": {
        ...
        description: "👀 Watchers & Listeners - Watchers, observers, and event listeners",
    },
    "app-lifecycle": {
        patterns: [
            "onBeforeMount",
        ...
        description: "🔄 App Lifecycle - Vue lifecycle hooks and framework configuration",
    },
};
function findGroupByPattern(name, groups) {
...
function extractFunctionCall(lineText) {
...
function getCategoryForFunction(word, lineText) {
...
exports.getCategoryForFunction = getCategoryForFunction;
//# sourceMappingURL=categoryDetector.js.map